...
WindowWin32::WindowWin32(const WindowProps& props) : m_props(props) {
    ...
    m_window = CreateWindowExA(0, "RyswickWindowClass", m_props.title, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, m_props.width, m_props.height, NULL, NULL, wc.hInstance, NULL);
